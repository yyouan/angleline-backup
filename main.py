...
if name =="console":
    ...
    print(os.system("git push https://github.com/yyouan/angleline-route.git master"))
    time.sleep(5)
    write_package_json("router_master.js")
    print(os.system("git add ."))
    print(os.system("git commit -m \"login\""))
    print(os.system("git push https://github.com/yyouan/angleline-master-route.git master"))
    time.sleep(5)
    write_package_json("router_info.js")
    print(os.system("git add ."))
    print(os.system("git commit -m \"login\""))
    print(os.system("git push https://github.com/yyouan/informationdesk-route.git master"))
    time.sleep(5)
    '''end'''
    ...
    time.sleep(5)
    write_package_json("login_2.js")
    print(os.system("git add ."))
    print(os.system("git commit -m \"login\""))
    print(os.system("git push https://github.com/yyouan/angleline-hall-route.git master"))
    time.sleep(5)
    write_package_json("info.js")
    print(os.system("git add ."))
    print(os.system("git commit -m \"login\""))
    ...
    print(os.system("git push https://github.com/yyouan/angleline-hall.git master"))
    time.sleep(5)
    write_package_json("router_hall.js")
    print(os.system("git add ."))
    print(os.system("git commit -m \"login\""))
    print(os.system("git push https://github.com/yyouan/angleline-hall-route.git master"))
    time.sleep(5)
