...
if name =="console":
    ...
    print(os.system("git pull https://github.com/yyouan/angleline-backup.git master --rebase")) 
    print(os.system("git pull https://github.com/yyouan/angleline.git master --rebase"))
    print(os.system("git pull https://github.com/yyouan/angleline-master.git master --rebase"))
    print(os.system("git pull https://github.com/yyouan/angleline-hall.git master --rebase"))
    print(os.system("git pull https://github.com/yyouan/informationdesk.git master --rebase"))
